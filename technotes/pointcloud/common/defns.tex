...
\definecolor{cc}{RGB}{19,23,224}
\usepackage[colorlinks=true, pagebackref=true,, citecolor=cc]{hyperref}
\geometry{left=2cm, top=1.5cm, right=3.5cm, bottom=1.5cm, footskip=.5cm} %
...
%\newcommand{\elbofinal}{\underline{\mathcal{L}}}
