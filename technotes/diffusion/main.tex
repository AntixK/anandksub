...
\begin{align}\label{eq:flow_ode}
    u_t(\vx_t) &= \lim_{\Delta t \to 0} \frac{f_t(\vx_t) - \vx_t}{\Delta t} \\
    &=   \lim_{\Delta t \to 0} \frac{ \vx_{t + \Delta t} - \vx_t}{\Delta t} \\ 
    &= \frac{d \vx_t}{dt} = 
\end{align}
Thus, we have shown that normalizing flows defined by equation \eqref{eq:res_flow} are the discrete form of ODEs.
